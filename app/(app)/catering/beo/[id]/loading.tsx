...
/** Loading scaffold for a BEO — header → lifecycle → menu (left) + facts (right). */
export default function Loading() {
  return (
    <div className="flex flex-col" style={{ gap: 'var(--space-6)' }}>
      ...
      <Card><Skeleton style={{ width: '60%', height: 24 }} /></Card>
      <div className="grid pn-today-main" style={{ gap: 'var(--space-6)' }}>
        <Card><div className="flex flex-col" style={{ gap: 'var(--space-3)' }}>{[0, 1, 2, 3].map((i) => <Skeleton key={i} style={{ height: 20 }} />)}</div></Card>
